    ...
    this.$parent.getJson(`/api/cart`)
      .then(data => {
        for (let el of data.contents) {
          item.imgProduct = `img/${el.id_product}.`;
          this.cartItems.push(el)
        }
      });
  },
  template: `<div>
            <button class="basket" type="button" @click="showCart = !showCart">
                <img class="bask__img" src="/img/basket.png" alt="basket">
            </button>
          <div class="cart__block" v-show="showCart">
          <p class="cart__block_no" v-if="!cartItems.length">В корзине нет товаров</p>
...
Vue.component('cart-item', {
  ...
  template: `
          <div class="cart-item">
            ...
            <p class="product_price">$ {{ cartItem.price }} one unit</p>
